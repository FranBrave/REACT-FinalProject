        ...
        <Grid display="flex">
          <Grid>
            ...
            <Grid className="city-name" display="flex" ml="40px">
              ...
              <Grid xs={1}>
                <Typography sx={{}}>{travelDetail.cityName}</Typography>
              </Grid>
            </Grid>
            <Box>
              <Typography
            ...
            <Box display="flex" flexDirection="row" ml="40px">
              <Grid xs={1}>
                <SvgIcon component={CalendarMonthIcon} sx={{}} />
              </Grid>
              <Grid xs={3}>
                <Typography sx={{}}>
                  Desde {travelDetail.dataFrom} hasta {travelDetail.dataTo}
                </Typography>
              </Grid>
            </Box>
            <Grid xs={1}>
              ...
              >
                ...
                <>
                  {userAuth &&
                    ...
                    travelDetail.usersWantJoin.length > 0 && (
